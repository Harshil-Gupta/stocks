...
def _is_indian_symbol(symbol: str) -> bool:
    ...
    return (
        ...
        upper in INDIA_NSE_SYMBOLS or
        upper in INDIA_INDICES or
...
class QuantTradingSystem:
    ...
    async def analyze_stock(self, symbol: str) -> Dict[str, Any]:
        ...
        result_dict = {
            ...
            "aggregated_signal": aggregated_signal.to_dict() if aggregated_signal else None,
            "data_points": len(df)
        }
...
Examples:
  ...
  %(prog)s live --symbols RELIANCE,INFY
    ...
    backtest_parser.add_argument(
        ...
        type=str,
        required=True,
        help='Stock symbols, comma-separated'
    )
    backtest_parser.add_argument(
        '--start',
        type=str,
...
def print_analysis_results(results: Dict[str, Any]) -> None:
    ...
    if agent_signals:
        ...
        for signal in agent_signals:
            ...
            print(f"  {signal_emoji} {agent_name:20s} | {signal_type:5s} | Conf: {confidence:5.1f}%")
